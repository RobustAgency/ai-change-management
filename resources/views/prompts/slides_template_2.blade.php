...
6. **Length & format rules:** 
  ...
  - `bullet_list` for each stakeholder — 3–5 points explaining how that stakeholder or group contributes to adoption, training, governance, or sustainment.
...
```json
{
  "slides_content": {
    ...
    "change_management_strategy_slide": { "numbers_list": ["", "", "", "", ""] }
  }
}
```
---
